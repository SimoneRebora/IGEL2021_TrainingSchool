...
# first, install the syuzhet library
install.packages("syuzhet") # you will have to do it only once
...
# as many warnings in R are useless (and annoying), you might want to disable them
options(warn = -1)
